...
// if everything is ok, try to upload file
  ...
  if ($uploadOk == 1 ) {
    ...
    $event->insertImg($authorID, $target, $alt);
            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" aria-describedby="emailHelp" placeholder="Enter Title"
                       value="<?php echo $content['title'] ;?>" disabled>
              </div>
              <div class="form-group">
                <label for="body">Body</label>
                <textarea name="body" class="form-control" placeholder="Body" disabled><?php echo strip_tags($content['body']); ?></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="date" name="date" class="form-control" placeholder="Date" value="<?php echo $content['date']; ?>" disabled>
              </div>
              <div class="form-group">
                <label for="author">Author</label>

                <input type="text" name="author" class="form-control" placeholder="Author" value="<?php echo $content['author']; ?>" disabled>
              </div>
              <div class="form-group">
                <label for="author">Start Time</label>

                <input type="text" name="startTime" class="form-control" placeholder="Start Time" value="<?php echo $result['startTime']; ?>" disabled>
              </div>
              <div class="form-group">
                <label for="author">End Time</label>

                <input type="text" name="endTime" class="form-control" placeholder="End Time" value="<?php echo $result['endTime']; ?>" disabled>
              </div>
              <div class="form-group">
                <label for="author">Campus</label>

                <input type="text" name="campus" class="form-control" placeholder="Campus" value="<?php echo $result['campus']; ?>" disabled>
              </div>
