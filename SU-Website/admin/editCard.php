...
<div id="content-wrapper">
    ...
    <div class="jumbotron">
      ...
      <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="title" maxlength="21" aria-describedby="emailHelp" placeholder="Enter Title"
        ...
        <div class="form-group">
          <label for="date" class="labels">URL</label>
  ...
  if ($check_ == 1) {
    echo "<script type='text/javascript'>swal('Card Updated');</script>";
  }
  ?>
  ?>
</body>
