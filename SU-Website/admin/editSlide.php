...
<div id="content-wrapper">
  ...
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Edit Slides</li>
    </ol>
    <!-- Page Content -->
  </div>
  <!-- /.container-fluid -->
  <div class="container mt-4">
    <div class="jumbotron">
      <h4 class="mb-4">Edit Slides</h4>

      <form action="" method="post" enctype="multipart/form-data">

        <input type="hidden" name="id" value="<?php echo $result['id']; ?>">
        <div class="form-group">
          <label for="text" class="labels">Text</label>
          <input type="text" class="form-control" name="text" maxlength="50" placeholder="Enter Slide Text"
                 value="<?php echo $result['slideText']; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label for="author" class="labels">Order</label>

          <input type="number" min="1" name="order" class="form-control" placeholder="Order" value="<?php echo $result['slideOrder']; ?>">
        </div>
  ...
  if ($check_ == 1) {
    echo "<script type='text/javascript'>swal('Slide Updated');</script>";
  }
  ?>
</body>
<script>
